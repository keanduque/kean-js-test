...
dogs.forEach(function (dog) {
  ...
  const result = Math.trunc(weight ** 0.75 * 28);
  dog.recommendedFood = result;
});
console.log(dogs);

//2
const findSarahsDog = dogs.find(dog => dog.owners.includes('Sarah'));
console.log(findSarahsDog);
const SarahsDogFoodPortion =
  findSarahsDog.curFood > findSarahsDog.recommendedFood
    ? "it's eating too much"
    : 'too little';

console.log(SarahsDogFoodPortion);
